...
function Caurosel(){
    ...
    <Carousel fade>
        ...
        <Carousel.Item>
            <img src={one}  style={{width:'100%',height:'560px'}} alt='img'/>
            <Carousel.Caption>
            <p style={{color:'orange',fontWeight:'1500px', fontSize:'40px'}}>Doris D Home And Event At Your Service</p>
            </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
        <img src={lol}  style={{width:'100%',height:'560px'}} alt='img'/>
        </Carousel.Item>
